  ...
  return (
    ...
    >
      ...
      <p>
        ...
        arbetsgivare förväntar sig det. Fråga om du inte förstår ett villkor.
      ...
      <p>
        Om det är en provanställning: kontrollera att prövotiden inte
        överstiger sex månader. Om det är visstid: kontrollera
      ...
      {/* Inline CTA — placed after intro sections, before the heavier content */}
      <InlineCTA />
      ...
      <p>
        Dessa formuleringar förekommer i avtal och bör granskas extra
        noga:
      </p>
      <ul>
        <li><strong>"Arbetsuppgifterna kan förändras"</strong> utan begränsning — ger arbetsgivaren för bred omplaceringsrätt</li>
        <li><strong>"Konkurrensförbud gäller i 36 månader"</strong> — överstiger vad som normalt är rimligt</li>
        <li><strong>"Alla immateriella rättigheter, även utanför arbetstid"</strong> — kan vara orimlig</li>
        <li><strong>Prövotid 7 månader</strong> — överstiger LAS-gränsen på 6 månader</li>
      </ul>
